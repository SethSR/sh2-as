...
impl From<Asm> for [u8;2] {
	fn from(asm: Asm) -> [u8;2] {
		...
		match atype {
			...
			Type::MovRegAdrB => [ 0x20 | n, 0x00 | m ],
			Type::MovRegAdrW => [ 0x20 | n, 0x01 | m ],
			Type::MovRegAdrL => [ 0x20 | n, 0x02 | m ],
			Type::MovAdrRegB => [ 0x60 | n, 0x00 | m ],
			Type::MovAdrRegW => [ 0x60 | n, 0x01 | m ],
			Type::MovAdrRegL => [ 0x60 | n, 0x02 | m ],
			Type::MovRegDecB => [ 0x02 | n, 0x04 | m ],
			Type::MovRegDecW => [ 0x02 | n, 0x05 | m ],
			Type::MovRegDecL => [ 0x02 | n, 0x06 | m ],
			Type::MovIncRegB => [ 0x06 | n, 0x04 | m ],
			Type::MovIncRegW => [ 0x06 | n, 0x05 | m ],
			Type::MovIncRegL => [ 0x06 | n, 0x06 | m ],
			...
			Type::MovRegR0B => [ 0x00 | n, 0x04 | m ],
			Type::MovRegR0W => [ 0x00 | n, 0x05 | m ],
			Type::MovRegR0L => [ 0x00 | n, 0x06 | m ],
			Type::MovR0RegB => [ 0x00 | n, 0x0C | m ],
			Type::MovR0RegW => [ 0x00 | n, 0x0D | m ],
			Type::MovR0RegL => [ 0x00 | n, 0x0E | m ],
			...
			Type::MacL => [ 0x00 | n, 0x0F | m ],
			Type::Mul => [ 0x00 | n, 0x07 | m ],
			...
			Type::BtS => [ 0x8D, d ],
			Type::Bra => [ 0xA0 | n, d ],
			Type::BraF => [ 0x00 | n, 0x23 ],
			Type::Bsr => [ 0xB0 | n, d ],
			Type::BsrF => [ 0x00 | n, 0x03 ],
			...
			Type::StcSrReg => [ 0x00 | n, 0x02 ],
			Type::StcGbrReg => [ 0x00 | n, 0x12 ],
			Type::StcVbrReg => [ 0x00 | n, 0x22 ],
			Type::StcSrDec => [ 0x40 | n, 0x03 ],
			Type::StcGbrDec => [ 0x40 | n, 0x13 ],
			Type::StcVbrDec => [ 0x40 | n, 0x23 ],
			Type::StsMachReg => [ 0x00 | n, 0x0A ],
			Type::StsMaclReg => [ 0x00 | n, 0x1A ],
			Type::StsPrReg => [ 0x00 | n, 0x2A ],
